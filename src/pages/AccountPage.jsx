  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.hero}>
        ...
        <h1 style={styles.title}>RBAC Authorization</h1>
      ...
      {!user ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          {user.role === 'ROLE_ADMIN' ? (
            ...
            // --- STANDARD USER CONTAINER ---
            <div style={styles.resultsContainer}>
              <h3 style={styles.resultsTitle}>My Portal</h3>
              <p style={{ margin: 0, color: '#6b7280' }}>
                You have standard user access. Admin level commands (Account Lookup, Database Search) are hidden from your console dashboard.
              </p>
            </div>
          )}
        </div>
